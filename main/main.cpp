...
#include "pulseSensorArduino.h"

//#define USE_ARDUINO_INTERRUPTS false
//#include <PulseSensorPlayground.h>

//  Pulsesensor.com Variables
...
#define BT_BLE_COEX_TAG             "MyLoopCoex"
#define BT_DEVICE_NAME              "MyLoop"
#define BLE_ADV_NAME                "MyLoopHealth"
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        rsp.attr_value.value[0] = val1;
        rsp.attr_value.value[1] = val2;
        rsp.attr_value.value[2] = val3;
        rsp.attr_value.value[3] = val4;
        rsp.attr_value.value[4] = val5;
        rsp.attr_value.value[5] = val6;
        rsp.attr_value.value[6] = val7;
...
extern "C" void app_main(void)
{
    ...
    i2s_config_t i2s_config = {
        ...
        .communication_format = static_cast<i2s_comm_format_t>(I2S_COMM_FORMAT_STAND_MSB), //2-channels
